...
so that the game never ends (Hint: write a function for this and call it 
...
is correct, add 1 point to the score (Hint: I'm going to use the power 
of closures for this, but you don't have to, just do this with the tools you 
